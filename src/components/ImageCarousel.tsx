...
const ImageCarousel = () => {
  ...
  const images = [
    ...
    // Posters
    { src: "/uploads/Snickers_shoes.jpg", name: "Snickers Shoes Poster" },
    { src: "/uploads/Cars.png", name: "Automotive poster Design" },
    { src: "/uploads/BMXcompitation.jpg", name: "BMX Competition Poster" },
    { src: "/uploads/musicshop_poster.jpg", name: "Music Shop Poster" },
    { src: "/uploads/Digitalmarket_course.jpg", name: "Digital Marketing Course Poster" },
    { src: "/uploads/Digitalmarket_course2.jpg", name: "Digital Marketing Course Poster 2" },
